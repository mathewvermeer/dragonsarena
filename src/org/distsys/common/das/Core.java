...
import org.distsys.common.das.presentation.BattleFieldViewer;
...
public class Core {
    ...
    public static void initializeGame(boolean showGui) {
        battlefield = BattleField.getBattleField();
        spawnUnits();
        if (showGui) startViewer();
        randomPlayerConnect();
    }

    private static void randomPlayerConnect() {
